...
// /* 명령형 프로그래밍 방식...지금까지 우리가 주로 학습한 코딩 스타일!
// const result = [];
...
// const assembleEvents = [...events]; // spread 연산자를 가지고 events 배열의 복사본을 만듦.

// const byDateAsc = assembleEvents/*[...events]*/.sort(
